...
\href{http://www.mcs.anl.gov/petsc/petsc-current/src/snes/examples/tutorials/ex5f.F90.html}{\trl{$PETSC_DIR/src/snes/examples/tutorials/ex5f.F90}};
...
\href{https://www.mcs.anl.gov/petsc/petsc-current/src/snes/examples/tutorials/ex5f.F90.html}{\trl{${PETSC_DIR}/src/snes/examples/tutorials/ex5f.F90}} give examples of user-defined
...
(\lstinline{TSRK5DP}), and the \sindex{Bogacki-Shampine} $5$th-order Bogacki-Shampine RK scheme with a $4$th-order embedded method
...
are \href{http://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/extchem.c.html}{\trl{$PETSC_DIR/src/ts/examples/tutorials/extchem.c}} 
and \href{http://www.mcs.anl.gov/petsc/petsc-current/src/ts/examples/tutorials/exchemfield.c.html}{\trl{$PETSC_DIR/src/ts/examples/tutorials/exchemfield.c}}.
...
\end{lstlisting}
A simple example of this kind of calculation is in \href{http://www.mcs.anl.gov/petsc/petsc-current/src/dm/impls/plex/plexfem.c.html#DMComputeL2Diff_Plex}{\trl{DMPlexComputeL2Diff_Plex()}}. Note that there is no restriction on the
...
\href{http://www.mcs.anl.gov/petsc/petsc-current/src/snes/examples/tutorials/ex1f.F90.html}{\trl{${PETSC_DIR}/src/snes/examples/ex1f.F90}}, respectively.  We also
...
For an example, see \href{http://www.mcs.anl.gov/petsc/petsc-current/src/dm/examples/tutorials/ex7.c.html}{\trl{${PETSC_DIR}/src/dm/examples/tutorials/ex7.c}}.
...
For an example, which includes sending data back to PETSc, see \href{http://www.mcs.anl.gov/petsc/petsc-current/src/vec/vec/examples/tutorials/ex42.c.html}{\trl{${PETSC_DIR}/src/vec/vec/examples/tutorials/ex42.c}} and the associated \trl{.m} file.
...
\item An MPI implementation may support a notion of {\it domains} in which a process may be pinned.
  ...
  sockets).
\item Separate from the specification of domains, MPI implementations often support different orderings in which MPI 
...
\href{http://www.mcs.anl.gov/petsc/petsc-current/src/snes/examples/tutorials/ex5f.F90.html}{\trl{${PETSC_DIR}/snes/examples/tutorials/ex5f.F90}} for examples of user-defined application
...
{\trl{http://stackoverflow.com/questions/829749}}.
...
More options can be included in a \trl{.pro} file; see \url{http://doc.qt.io/qt-5/qmake-project-files.html}. 
